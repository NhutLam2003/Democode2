...
namespace QLSV {
    ...
    public partial class QLSVDataSet : global::System.Data.DataSet {
        ...
        public partial class SinhVienDataTable : global::System.Data.TypedTableBase<SinhVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SinhVienRow AddSinhVienRow(int ID, string MSSV, string Ho, string Ten, LopRow parentLopRowByFK_SinhVien_Lop, System.DateTime NgaySinh, string DiaChi, short TrangThai) {
        ...
        public partial class SinhVienRow : global::System.Data.DataRow {
            ...
            public string MSSV {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'MSSV\' in table \'SinhVien\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsMSSVNull() {
                return this.IsNull(this.tableSinhVien.MSSVColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetMSSVNull() {
                this[this.tableSinhVien.MSSVColumn] = global::System.Convert.DBNull;
            }
...
namespace QLSV.QLSVDataSetTableAdapters {
    ...
    public partial class SinhVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[SinhVien] WHERE (([ID] = @Original_ID) AND ((@IsNull_MSSV = 1 AND [MSSV] IS NULL) OR ([MSSV] = @Original_MSSV)) AND ((@IsNull_Ho = 1 AND [Ho] IS NULL) OR ([Ho] = @Original_Ho)) AND ((@IsNull_Ten = 1 AND [Ten] IS NULL) OR ([Ten] = @Original_Ten)) AND ((@IsNull_MaLop = 1 AND [MaLop] IS NULL) OR ([MaLop] = @Original_MaLop)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_TrangThai = 1 AND [TrangThai] IS NULL) OR ([TrangThai] = @Original_TrangThai)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[SinhVien] ([ID], [MSSV], [Ho], [Ten], [MaLop], [NgaySinh], [DiaChi], [TrangThai]) VALUES (@ID, @MSSV, @Ho, @Ten, @MaLop, @NgaySinh, @DiaChi, @TrangThai);
SELECT ID, MSSV, Ho, Ten, MaLop, NgaySinh, DiaChi, TrangThai FROM SinhVien WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SinhVien] SET [ID] = @ID, [MSSV] = @MSSV, [Ho] = @Ho, [Ten] = @Ten, [MaLop] = @MaLop, [NgaySinh] = @NgaySinh, [DiaChi] = @DiaChi, [TrangThai] = @TrangThai WHERE (([ID] = @Original_ID) AND ((@IsNull_MSSV = 1 AND [MSSV] IS NULL) OR ([MSSV] = @Original_MSSV)) AND ((@IsNull_Ho = 1 AND [Ho] IS NULL) OR ([Ho] = @Original_Ho)) AND ((@IsNull_Ten = 1 AND [Ten] IS NULL) OR ([Ten] = @Original_Ten)) AND ((@IsNull_MaLop = 1 AND [MaLop] IS NULL) OR ([MaLop] = @Original_MaLop)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_TrangThai = 1 AND [TrangThai] IS NULL) OR ([TrangThai] = @Original_TrangThai)));
SELECT ID, MSSV, Ho, Ten, MaLop, NgaySinh, DiaChi, TrangThai FROM SinhVien WHERE (ID = @ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual int Delete(int Original_ID, string Original_MSSV, string Original_Ho, string Original_Ten, string Original_MaLop, global::System.Nullable<global::System.DateTime> Original_NgaySinh, global::System.Nullable<short> Original_TrangThai) {
            ...
            if ((Original_TrangThai.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((short)(Original_TrangThai.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int ID, string MSSV, string Ho, string Ten, string MaLop, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, global::System.Nullable<short> TrangThai) {
            ...
            if ((TrangThai.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[7].Value = ((short)(TrangThai.Value));
            }
            else {
        ...
        public virtual int Update(int ID, string MSSV, string Ho, string Ten, string MaLop, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, global::System.Nullable<short> TrangThai, int Original_ID, string Original_MSSV, string Original_Ho, string Original_Ten, string Original_MaLop, global::System.Nullable<global::System.DateTime> Original_NgaySinh, global::System.Nullable<short> Original_TrangThai) {
            ...
            if ((TrangThai.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((short)(TrangThai.Value));
            }
            else {
            ...
            if ((Original_TrangThai.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((short)(Original_TrangThai.Value));
            }
            else {
        ...
        public virtual int Update(string MSSV, string Ho, string Ten, string MaLop, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, global::System.Nullable<short> TrangThai, int Original_ID, string Original_MSSV, string Original_Ho, string Original_Ten, string Original_MaLop, global::System.Nullable<global::System.DateTime> Original_NgaySinh, global::System.Nullable<short> Original_TrangThai) {
            return this.Update(Original_ID, MSSV, Ho, Ten, MaLop, NgaySinh, DiaChi, TrangThai, Original_ID, Original_MSSV, Original_Ho, Original_Ten, Original_MaLop, Original_NgaySinh, Original_TrangThai);
        }
    }
